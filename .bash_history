...
python manage.py makemigrations general
python manage.py makemigrations --empty general
python manage.py makemigrations
python manage.py makemigrations general
rm -rf general/migrations/*
python manage.py makemigrations
rm -rf general/migrations/*
python manage.py makemigrations
...
pip install unidecode
 /usr/bin/env /usr/local/bin/python3 /root/.vscode-server/extensions/ms-python.debugpy-2024.0.0-linux-x64/bundled/libs/debugpy/adapter/../../debugpy/launcher 42301 -- /root/manage.py runserver 
python manage.py runserver
python manage.py runserver
python manage.py runserver
